...
public class ConexionRemota {
    ...
    public Connection verificaConexionMySql(String puerto, String user, char[] passwd)throws ClassNotFoundException{
        try{
            ...
            conexion = (Connection) DriverManager.getConnection("jdbc:mysql://"
                    +"156.67.72.1"+":"+puerto+"/"+"u180896079_fenixact"+zoneDateTime,user, strpassword);
    ...
    public Connection conexionMySql()throws ClassNotFoundException{
        try{
            Class<?> forName = Class.forName("com.mysql.cj.jdbc.Driver");            
            conexion = (Connection) DriverManager.getConnection("jdbc:mysql://"
                    +"156.67.72.1"+":"+"3306"+"/"+"u180896079_fenixact"+zoneDateTime,"u180896079_jraraujo", "Superunknown0!");
            System.out.println(conexion);
            System.out.println("Conexion establecida con exito");
