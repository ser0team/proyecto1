 ...
 * @author jraraujo
 */
public class Anaqueles extends javax.swing.JFrame {
    ...
    public Anaqueles() {
        ...
        cha.revisarAccesosAnaquel(Menu.idusu);
    ...
    private void initComponents() {
        ...
        jbpasillo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jbpasillo, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtxtanaquel, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("Registro de Anaqueles", jPanel1);
        ...
        jtanaqueles.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtanaquelesKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(jtanaqueles);
    ...
    private void jbguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbguardarActionPerformed
         ...
         if(jtxtanaquel.getText().equals("") || jtxtidpasillo.getText().equals("")){
            jtm.jTextAreaMessage("Existen campos vacios");
        }else{
            ana.jbguardar(jtxtanaquel.getText(), 
                    jtxtdescripcion.getText(), 
                Integer.parseInt(jtxtidpasillo.getText()), 
                Menu.idusu, 
                Menu.idcompania);
            ana.jbcancelar(jtxtanaquel, jtxtdescripcion, jtxtidpasillo);
            ana.mostrarRegistros(jtanaqueles, 0, 0, Menu.idcompania);
        }
    ...
    private void jbeliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbeliminarActionPerformed
        ...
        if(String.valueOf(idanaquel).equals("")){
            jtm.jTextAreaMessage("No se ha seleccionado anaquel");
        }else{
            ana.jbeliminar(idanaquel, Menu.idcompania);
            ana.jbcancelar(jtxtanaquel, jtxtdescripcion, jtxtidpasillo);
            ana.mostrarRegistros(jtanaqueles, 0, 0, Menu.idcompania);
        }
    ...
    private void jbmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbmodificarActionPerformed
        ...
        if(String.valueOf(idanaquel).equals("")){
            ...
            ana.jbmodificar(jtxtanaquel.getText(), 
                    jtxtdescripcion.getText(), 
                    Integer.parseInt(jtxtidpasillo.getText()), 
                    Menu.idusu, 
                    Menu.idcompania, 
    ...
    private void jbexportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbexportarActionPerformed
        ...
        fexpex.exportarExcel(jtanaqueles);
    ...
    private void jbreporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbreporteActionPerformed
        ...
        try {
            rep.EmisionReporteDeAlmacenes("/ReportesJasper/", "ReporteAnaqueles.jasper", Menu.idcompania);
        } catch (JRException ex) {
            Logger.getLogger(Anaqueles.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jtanaquelesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtanaquelesMouseClicked
        ...
        idanaquel = Integer.parseInt(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 0).toString());
        jtxtanaquel.setText(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 1).toString());
        jtxtdescripcion.setText(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 2).toString());
        jtxtidpasillo.setText(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 3).toString());
        
    }//GEN-LAST:event_jtanaquelesMouseClicked

    private void jtanaquelesKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtanaquelesKeyReleased

        jtanaqueles.setSurrendersFocusOnKeystroke(true);
        if(evt.getKeyChar() == KeyEvent.VK_ENTER){
            ana.jbmodificar(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 1).toString(), 
                    jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 2).toString(), 
                    Integer.parseInt(jtanaqueles.getValueAt(jtanaqueles.getSelectedRow(), 3).toString()), 
                    Menu.idusu, 
                    Menu.idcompania, 
                    idanaquel);
            ana.jbcancelar(jtxtanaquel, jtxtdescripcion, jtxtidpasillo);
    ...
    }//GEN-LAST:event_jtanaquelesKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anaqueles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
